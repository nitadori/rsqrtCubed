...
#else
			asm volatile ("#HERE#");
			svfloat32_t dx = svsubr_n_f32_x(p0, xi, body[j].x);
			svfloat32_t dy = svsubr_n_f32_x(p0, yi, body[j].y);
			svfloat32_t dz = svsubr_n_f32_x(p0, zi, body[j].z);
#endif
