...
int main(){
	...
	__m512 xv = _mm512_loadu_ps(SoA[0]);
	__m512 yv = _mm512_loadu_ps(SoA[1]);
	__m512 zv = _mm512_loadu_ps(SoA[2]);
	...
	_mm512_storeu_ps(AoS[0]+ 0, xyzlow);
	_mm512_storeu_ps(AoS[0]+16, xyzmid);
	_mm512_storeu_ps(AoS[0]+32, xyzhig);
